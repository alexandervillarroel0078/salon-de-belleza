    ...
    <AppLayout
        ...
        <div class="mt-4 bg-white shadow-md p-4 rounded-lg">
            <div class="flex justify-end">
                <Button
                    size="small"
                    @click="$inertia.get(route('services.create'))">
                    <i class="fa-solid fa-plus"></i>
                    Crear Servicio  
                </Button>
            </div>

            <DataTable :value="page.props.services" :paginator="true" :rows="10" class="mt-4">
                ...
                <Column header="Acciones">
                    <template #body="{ data }">
                        <Button size="small" icon="fa fa-pencil" @click="$inertia.get(route('services.edit', data.id))"></Button>
                        <Button size="small" icon="fa fa-trash" class="ml-2" @click="$inertia.delete(route('services.destroy', data.id))"></Button>
                    </template>
                </Column>
            </DataTable>
